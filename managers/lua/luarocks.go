...
func (m LuarocksManager) Fetch() ([]managers.Dependency, error) {
...
func parseLuarocksOutput(data []byte) ([]managers.Dependency, error) {
...
func (m LuarocksManager) FetchDetails(dep managers.Dependency) (managers.PackageDetails, error) {
	return managers.PackageDetails{Name: dep.Name, Version: dep.Version}, nil
}
func (m LuarocksManager) Uninstall(dep managers.Dependency) error {
